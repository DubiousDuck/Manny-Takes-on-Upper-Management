...
enum EffectType {DAMAGE, KNOCKBACK, HEAL, BUFF, DEBUFF, STUN, ACTION_COMMAND, WAIT, DISPLACE, DAMAGE_REDUCTION}
#DAMAGE = 0, KNOCKBACK = 1, HEAL = 2, BUFF = 3, DEBUFF = 4, STUN = 5, ACTION_COMMAND = 6, WAIT = 7, DISPLACE = 8, DAMAGE_REDUCTION = 9
