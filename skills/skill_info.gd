...
enum EffectType {DAMAGE, KNOCKBACK, HEAL, BUFF, DEBUFF, STATUS, ACTION_COMMAND, WAIT, DISPLACE, SET_TILE, ACTION_TOKEN, SELF_BUFF, SELF_HEAL}
#DAMAGE = 0, KNOCKBACK = 1, HEAL = 2, BUFF = 3, DEBUFF = 4, STATUS = 5, ACTION_COMMAND = 6, WAIT = 7, DISPLACE = 8, SET_TILE = 9, ACTION_TOKEN = 10
...
# action_token: Unit.Action.MOVE or Unit.Action.ATTACK
